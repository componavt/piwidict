...
//print mysql_num_rows($this->result);
	...
	/* Translate line to associative array */
	...
	/* Translate the whole request to the associative array */
	...
	/* Delete record from the $table by field $id_field which is equal to $id */
